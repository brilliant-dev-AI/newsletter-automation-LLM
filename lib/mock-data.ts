...
export const MOCK_LINKS: Link[] = [
  {
    ...
    context: 'Remote position in New York, NY with salary range $160,000-$240,000',
    category: 'job',
    relevance: 8,
  ...
  },
  {
    ...
    context: 'Latest insights from Stack Overflow on fostering great engineering teams',
    category: 'article',
    relevance: 7,
  ...
  },
  {
    ...
    context: 'OpenAI announces improved GPT-4 with better performance and lower costs',
    category: 'product',
    relevance: 8,
    extractionMethod: 'llm',
  ...
  },
  {
    ...
    context: 'Latest updates to Next.js including improved performance and new features',
    category: 'tool',
    relevance: 9,
    extractionMethod: 'html_parser',
  ...
  },
  {
    ...
    context: 'TechCrunch reports on the latest AI funding trends and market insights',
    category: 'news',
    relevance: 7,
    extractionMethod: 'html_parser',
